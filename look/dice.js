...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-9c783e29');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-9c783e29');}
...
function clearFlash(){dieView.classList.remove('rl-win-9c783e29');dieView.classList.remove('rl-lose-9c783e29');if(frameEl){frameEl.classList.remove('rl-win-9c783e29');frameEl.classList.remove('rl-lose-9c783e29');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-9c783e29');if(frameEl){frameEl.classList.add('rl-win-9c783e29');}}else{dieView.classList.add('rl-lose-9c783e29');if(frameEl){frameEl.classList.add('rl-lose-9c783e29');}}
...
var brandEl=document.querySelector('.rl-brand-9c783e29');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
